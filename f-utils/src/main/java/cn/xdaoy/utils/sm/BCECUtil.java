...
public class BCECUtil {
	 ...
	 * @param domainParameters EC
	 *                         Domain参数，一般是固定的，如果是SM2算法的可参考{@link SM2Util#DOMAIN_PARAMS}
	 * @return
	 */
	 ...
	 * @return
	 */
	public static ECPublicKeyParameters createECPublicKeyParameters(BigInteger x, BigInteger y, ECCurve curve,
			ECDomainParameters domainParameters) {
	...
	public static ECPublicKeyParameters createECPublicKeyParameters(String xHex, String yHex, ECCurve curve,
			ECDomainParameters domainParameters) {
		return createECPublicKeyParameters(ByteUtils.fromHexString(xHex), ByteUtils.fromHexString(yHex), curve,
				domainParameters);
	}
