...
public class SM2Pkcs12Maker {
	 ...
	 */
	public KeyStore makePkcs12(PrivateKey privKey, X509Certificate[] chain, char[] passwd) throws KeyStoreException,
	 ...
	 * @throws PKCSException
	 */
	public KeyStore makePkcs12(PrivateKey privKey, X509Certificate cert, char[] passwd) throws KeyStoreException,
			NoSuchProviderException, NoSuchAlgorithmException, CertificateException, IOException {
